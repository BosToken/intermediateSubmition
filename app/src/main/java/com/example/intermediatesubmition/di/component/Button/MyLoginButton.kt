package com.example.intermediatesubmition.di.component.Button
...
class MyLoginButton : AppCompatButton{
    ...
    private fun init(){
        ...
        enableBtn = ContextCompat.getDrawable(context, R.drawable.bg_btn_enable) as Drawable
        disableBtn = ContextCompat.getDrawable(context, R.drawable.bg_btn_disable) as Drawable
    }
}